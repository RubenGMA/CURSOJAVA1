...
public class Trabajo implements Serializable{
	...
	//ATRIBUTOS	
	@Id @Column(name="JOB_ID") 	private String id;
	@Column(name="JOB_TITLE")	private String tituloTrabajo;
	@Column(name="MIN_SALARY")	private Double salarioMin;
	@Column(name="MAX_SALARY")	private Double salarioMax;
