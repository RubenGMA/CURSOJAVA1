...
public class TestBanking {
	public static void main(String[] args) {
	    ...
	    customer.setAccount(new SavingsAccount(550.00, 0.03));
	    ...
	    customer.setAccount(new CheckingAccount(490.00));
	    ...
	    customer.setAccount(new CheckingAccount(700.00, 400.00));

	    System.out.println("Creando cliente Maria Soley.");
	    bank.addCustomer("Maria", "Soley");
	    customer = bank.getCustomer(bank.getNumberOfCustomers()-1);
	    System.out.println("Maria comparte Checking Account con su marido Tim.");
	    customer.setAccount(bank.getCustomer(bank.getNumberOfCustomers()-2).getAccount());
